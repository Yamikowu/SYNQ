  ...
  <nav class="max-w-7xl mx-auto px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      ...
      <ul class="hidden lg:flex items-center gap-8" role="list">
        ...
        <li><a href="keyboard.html" data-nav="keyboard" class="text-sm font-medium text-gray-400 hover:text-ice transition-colors duration-200 tracking-wide">Keyboard</a></li>
    ...
    <div id="mobile-menu" class="lg:hidden" role="navigation" aria-label="行動版選單">
      <div class="py-4 border-t border-white/05 flex flex-col gap-1">
        ...
        <a href="keyboard.html" data-nav="keyboard" class="px-3 py-3 text-sm text-gray-300 hover:text-ice hover:bg-white/5 rounded-lg transition-all">Keyboard</a>
...
<footer class="border-t border-white/06 bg-dark">
  <div class="max-w-7xl mx-auto px-6 py-16">
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-14">
      ...
      <div><h4 class="text-xs font-mono font-bold tracking-widest text-gray-500 uppercase mb-5">Products</h4><ul class="space-y-3"><li><a href="controller.html" class="footer-link">AI Controller</a></li><li><a href="keyboard.html" class="footer-link">OLED Keyboard</a></li><li><a href="macro.html" class="footer-link">Macro Deck</a></li></ul></div>
      ...
      <div><h4 class="text-xs font-mono font-bold tracking-widest text-gray-500 uppercase mb-5">Company</h4><ul class="space-y-3"><li><a href="#" class="footer-link">About</a></li><li><a href="#" class="footer-link">Press</a></li><li><a href="#" class="footer-link">Contact</a></li></ul></div>
    </div>
